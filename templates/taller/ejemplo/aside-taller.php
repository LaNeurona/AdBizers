<div class="row bg-aside">
	...
	<div class="col-xs-12 formador-aside text-center">
		...
		<img src="img/formador-img.png" alt="" style="margin-top: .7em">
		<h3 class="text-center purpura">Ana Sierra</h3>
		<h5 class="text-center">Psicóloga General y Sexóloga</h5>
		<div class="rrss-formador">
			...
			<a href="#"><span class="fab fa-linkedin-in fa-2x purpura"></span></a>
		</div>
	...
	<div class="col-xs-12 detalles-aside">
		...
		<div>
			...
			<h5 class="purpura">Precio del curso: <strong>250 €</strong></h5>
	...
	<div class="col-xs-12 convocatoria-aside">
		<h4 class="purpura border-aside">Fechas y Sedes</h4>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-xs-9 aside-data">
				<p>14 febrero 2019</p>
				<p>Ibercaja Centro de Negocios</p>
				<p>Calle de Alcalá, 29</p>
			</div>
		</div>		
		<div class="row">
			<div class="col-xs-12 aside-button">
				<a href="https://interbanservices.com/formularios/form_adbizers/a000X000015Z9A8">INSCRIPCIÓN</a>
		...
		<div class="row pdf-aside">
			<div class="col-xs-12 text-center"><a href=""><span class="purpura far fa-file-pdf"></span><span>Descargar temario PDF</span></a></div>
		</div>
	...
	<div class="col-xs-12 rrss-aside">
		...
		<div class="row">
					<div class="col-xs-4 text-center"><span class="fab fa-facebook-square fa-2x purpura"></span></div>
					<div class="col-xs-4 text-center"><span class="fab fa-facebook-square fa-2x purpura"></span></div>
					<div class="col-xs-4 text-center"><span class="fab fa-facebook-square fa-2x purpura"></span></div>
				</div>		
	</div> <!-- /.rrss-aside -->			
