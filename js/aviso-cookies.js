...
console.log('aviso-cookies working');
...
function showCookiesMsg() {
	...
	if (document.cookie.indexOf(cookie_name + '=1') < 0) {
		document.head.innerHTML += '<style type="text/css">' +
			'.__cookies_msg a:hover { background:rgba(0,0,0,0.6) !important }' +
...
function showCookiesPopup() {
    ...
    popup.document.write('<!doctype html><html>' +
		'<head>' +
			...
			'<style type="text/css">' +
				'body { margin:0; padding:20px; background:#ffffff; color:rgba(0,0,0,.8); font-size:14px }' +
				'p, h1, h2 { font-family:Source Sans Pro, sans-serif }' +
